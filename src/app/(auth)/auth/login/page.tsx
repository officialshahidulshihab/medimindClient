...
export default function LoginPage() {
  ...
  function handleDemo() {
    const demoEmail = "demo@medimind.com"
    ...
    >
      ...
      >
        ...
        <button
          ...
          type="button"
          className="w-full mt-[24px] flex items-center justify-center gap-[10px] transition-colors"
          style={{ 
            height: '48px', 
            borderRadius: '8px', 
            background: 'white', 
        ...
        <form onSubmit={handleSubmit} className="flex flex-col w-full">
          ...
          >
            {loading ? <LoadingSpinner className="w-5 h-5 text-navy" /> : 'Sign In'}
          </button>
        </form>
